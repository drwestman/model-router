...
import { MODE_COMMAND_NAME, resolveModeName, validateConfig as validateCanonicalConfig, } from "@drwestman/model-router-core";
...
export function buildModeOutput(cfg, args) {
