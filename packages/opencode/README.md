...
- For local OpenCode development, run `npm run install-opencode:local` from the monorepo root to register `~/.config/opencode/plugins/model-router.js` and the matching `~/.config/opencode/plugins/package.json` ESM marker.
